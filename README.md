...
_Last run: **2026-07-29 13:41 UTC** · callix `main` · runner `Linux x86_64` · single cold run, indicative only._

| Project | Lang | Commit | LOC | Files | Nodes | Relations | Time | Peak RSS | KLOC/s | Resolver | Resolved |
|---|---|---|--:|--:|--:|--:|--:|--:|--:|:--|--:|
| [apache/superset](https://github.com/apache/superset) | python | `c83fb2b` | 399 519 | 1 886 | 179 311 | 379 535 | 16.8s | 1,005 MB | 23.7 | ok | 84% of 281 667 (10s) |
...
| **Total** | | | **1 590 441** | | **398 228** | | **412.6s** | | **3.9** | | **92% of 604 004** |
